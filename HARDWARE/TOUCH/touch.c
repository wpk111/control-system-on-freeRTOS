...
void TP_Save_Adjdata(void)
{
	...
	STMFLASH_Write(0X08070000,(u16*)&tp_dev.xfac,7);//把数据存储在flash的地址0X08070000开始的空间
	STMFLASH_Write(0X08070010,(u16*)&temp,1);
	//设计保存方式，把数据保存到内部flash的最后部分
}
//得到保存在EEPROM里面的校准值
//返回值：1，成功获取数据
//        0，获取失败，要重新校准
...
{					  
	...
	//STMFLASH_Read(0X08070020,(u16*)&temp,1);
	//AT24CXX_Read(SAVE_ADDR_BASE,(u16*)&tp_dev.xfac,14);
	...
	if(temp==0X0A)//触摸屏已经校准过了			   
 	{ 
		...
		STMFLASH_Read(0X08070000,(u16*)&tp_dev.xfac,7);
